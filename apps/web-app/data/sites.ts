export const sites = {
    vitalia: {
        ...
        description:
            "A 2-month long camp to explore the foundation of a new city - Vitalia, a city that will be run around the idea that “life is good, death is bad”. It will harbour renegade life scientists, biotechnology engineers and an entrepreneurially driven community of people that care.",
        name: "Vitalia",
        subdomain: "vitalia",
        posts: [],
